...
## Detection 
Looking in Wazuh Dashboard > Threat Intelligence > Threat Hunting, I see that these SSH failures were logged:
<img width="3436" height="1760" alt="image" src="https://github.com/user-attachments/assets/f860beba-e5bd-461d-b6a0-e76c21ad4fc7" />

And looking in Wazuh Dashboard > Explore > Discover, I can see the event logs:
